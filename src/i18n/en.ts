...
export const en: LocaleDict = {
  ...
  cardReviewCount: (n: number) => `Reviewed ${n}×`,
  cardEdit: "Edit",
  ...
  cardBatchSelected: (n: number) => `${n} selected`,
  ...
  cardReviewStat: (n: number, m: number) => `Reviewed ${n}, mastered ${m}`,
  ...
  cardConfirmBatchDelete: (n: number) => `Delete ${n} selected annotations?`,
  cardNoticeTagAdded: "Tag added",
  cardNoticeTagRemoved: "Tag removed",
  cardNoticeBatchDeleted: (n: number) => `${n} annotations deleted`,
  cardNoticeBatchTagged: (n: number) => `Tagged ${n} annotations`,
