...
export const zhCN: LocaleDict = {
  ...
  // AnnoCard 卡片化管理新增
  cardArchived: "已归档",
  cardReviewCount: (n: number) => `复习 ${n} 次`,
  cardEdit: "编辑",
  ...
  cardBatchTag: "给选中打标签",
  cardBatchCancel: "取消",
  cardBatchSelected: (n: number) => `已选 ${n} 项`,
  cardLoadMore: "加载更多",
  cardReviewStart: "复习",
  cardReviewExit: "退出复习",
  cardReviewNext: "下一张",
  ...
  cardReviewStat: (n: number, m: number) => `共复习 ${n} 张,掌握 ${m} 张`,
  ...
  cardConfirmBatchDelete: (n: number) => `确认删除选中的 ${n} 条标注?`,
  cardNoticeTagAdded: "已添加标签",
  cardNoticeTagRemoved: "已删除标签",
  cardNoticeBatchDeleted: (n: number) => `已删除 ${n} 条标注`,
  cardNoticeBatchTagged: (n: number) => `已为 ${n} 条标注打标签`,
